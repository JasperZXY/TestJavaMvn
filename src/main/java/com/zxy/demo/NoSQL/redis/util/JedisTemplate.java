 ...
 *******************************************************************************/
package com.zxy.demo.NoSQL.redis.util;
...
/**
 * JedisTemplate 提供了一个template方法，负责对Jedis连接的获取与归还。<br/>
 * JedisAction<T> 和 JedisActionNoResult两种回调接口，适用于有无返回值两种情况。<br/>
 * PipelineAction 与 PipelineActionResult两种接口，适合于pipeline中批量传输命令的情况。<br/>
 *
 * 同时提供一些JedisOperation中定义的 最常用函数的封装, 如get/set/zadd等。<br/><br/>
 *
 * <strong>结合spring使用</strong>
 * <blockquote><pre>
 ...
 &lt;bean id="jedisTemplate" class="cn.ue.commons.db.redis.JedisTemplate" destroy-method="destroy">
 	&lt;constructor-arg index="0" ref="jedisPool"/>
 &lt;/bean>
 * </pre></blockquote>
 *
 * <strong>Java直接使用</strong>
 * <blockquote><pre>
...
public class JedisTemplate {
	...
	public Boolean srem(final String key, final String... members) {
		return execute(new JedisAction<Boolean>() {
			...
			@Override
			public Boolean action(Jedis jedis) {
				return jedis.srem(key, members) == members.length ? true : false;
			}
		});
	}
